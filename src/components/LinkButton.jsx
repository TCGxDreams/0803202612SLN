...
const platformIcons = {
  ...
  zalo: (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
      <path d="M12 0C5.373 0 0 5.037 0 11.25c0 3.537 1.702 6.687 4.372 8.832-.078 1.163-.403 2.753-.801 3.918 1.376-.654 3.114-1.513 4.088-2.064A13.21 13.21 0 0012 22.5c6.627 0 12-5.037 12-11.25S18.627 0 12 0zm5.05 15.2H8.95c-.386 0-.7-.298-.7-.666s.314-.667.7-.667h2.1V9.733L8.4 14.867a.708.708 0 01-.587.333.689.689 0 01-.513-.233.635.635 0 01.1-.9l3.5-3.8V8.133c0-.366.314-.666.7-.666s.7.3.7.666v5.734h2.1c.386 0 .7.299.7.667s-.264.666-.65.666z"/>
    </svg>
  ),
};
...
function detectPlatform(url) {
  ...
  if (u.includes('tiktok.com') || u.includes('tik.tok')) return 'tiktok';
  ...
  if (u.includes('zalo.me') || u.includes('zalo.vn')) return 'zalo';
